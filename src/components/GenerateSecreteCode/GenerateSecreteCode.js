...
function GenerateSecretCode() {
  ...
  return (
    <div className="generate-secret-code-overlay">
      <div
        className={`generate-secret-code-modal ${
          isDarkMode ? "switch" : "light"
        }`}
      >
        ...
        <div className="generate-input-container">
          <TextField
            ...
            placeholder="Enter name to be shared as eg.PHYSICS   "
        ...
        <div className="generate-secrete-selected-ids">
          <h3>
            {isLoading ? "Generating Secret Code" : "Files to be shared:"}
          </h3>
          {isLoading ? (
            <LinearProgress />
          ) : (
      ...
      <Snackbar
        open={receiveFileStatus==='succeeded'}
